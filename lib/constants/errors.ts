...
export const ERR_BILLING_CHECKOUT_FAILED =
  '決済ページの準備に失敗しました。時間をおいて再試行してください'
export const ERR_BILLING_PORTAL_FAILED =
  'お支払い管理ページの準備に失敗しました。時間をおいて再試行してください'
export const ERR_BILLING_NO_SUBSCRIPTION = '有効なサブスクリプションが見つかりません'
